 ...
 *
 * The boundary is a comma-separated list of relative paths or globs. Because
 * picomatch is used, `app/auth.py` matches exactly `app/auth.py` and `app/**`
 * matches any nested path. Dot-files (`.github/`) are matched with `dot: true`.
 */
